    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-white">Nueva noticia</h1>
                <p class="mt-2 text-sm text-gray-700 dark:text-gray-300">
                    Publica novedades que aparecerán en la sección de noticias del sitio público.
                </p>
            </div>
        </div>
                            ...
                            <div class="flex">
                                <div class="flex-shrink-0">
                                    <svg class="h-5 w-5 text-red-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.06L10 11.06l1.72 1.72a.75.75 0 101.06-1.06L11.06 10l1.72-1.72a.75.75 0 00-1.06-1.06L10 8.94 8.28 7.22z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <div class="ml-3">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Se mostrará como resumen en la tarjeta y en redes sociales.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                Sube un PDF u otro documento relacionado con la noticia (máx. 8 MB).
                            </p>
                        </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    >
                                        ...
                                        <option value="publicada" {{ old('estado') === 'publicada' ? 'selected' : '' }}>
                                            Publicada
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <input
                                        ...
                                        name="publicado_en"
                                        id="publicado_en"
                                        value="{{ old('publicado_en') }}"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 dark:bg-zinc-800 dark:text-white dark:ring-zinc-700"
                                    >
                                </div>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Si lo dejas vacío y el estado es publicada, se usará la hora actual.
                                </p>
                            </div>
